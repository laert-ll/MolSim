...
namespace fileReaders {
    ...
    void TXTReader::loadCuboids(const std::vector<std::string> &lines, ParticleContainer &particles) {
    ...
    std::vector<std::string> TXTReader::readFileLines(const std::string &filepath) {
