...
void VTKWriter::plotParticle(Particle &p) {
    if (vtkFile->UnstructuredGrid().present()) {
        SPDLOG_INFO("UnstructuredGrid is present");
    } else {
    ...
    dataIterator++;
    dataIterator->push_back(p.getVolume()); // Add volume data
